...
```{r}
# First 2 columns of the original dataset
head(D, n = 2L)
```
...
I will now create a subset NBA and Euroleague data since they are the 2 subjectively best(in ability) basketball leagues in the world. I will subset data for each league to allow players that
```{r}
