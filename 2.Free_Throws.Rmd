...
KBTDData <- data.frame(Yr03_04[1:6], Yr04_05[1:6], Yr05_06[1:6], Yr06_07[1:6], Yr07_08[1:6], Yr08_09[1:6], Yr09_10[1:6], Yr10_11[1:6],Yr11_12[1:6], Yr12_13[1:6])
colnames(KBTDData) <- c("03-04", "04-05", "05-06", "06-07","07_08", "08-09", "09-10", "10-11", "11-12", "12-13")

require(pander)
pandoc.table(KBTDData, style = 'grid', caption = "Kobe/Duncan Era('03-'13)")
```
...
Other than the 11-12 era(which is inflated becuase the season was shortened due to lockout), the histogram distriutions from this era look similar to the Jordan era's.
