...
Seems like the quartiles and medians for FT% are similar to each other through the years so it's safe to assume the era cutoff holds for the data so far. Let's see this data visually through a histogram and density chart.
...
The 1st quartile in this era is a little lower than the Jordan era since the Jordan era's were around 0.70 for them; however, he median is around the same(0.76)
...
Other than the 11-12 era(which is inflated because the season was shortened due to lockout), the histogram distributions from this era look similar to the Jordan era's.
